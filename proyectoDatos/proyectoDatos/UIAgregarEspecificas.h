...
namespace proyectoDatos { 
	...
	/// <summary>
	/// Summary for UIAgregarEspecificas
	/// </summary>
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(UIAgregarEspecificas::typeid));
			...
			this->label5->Size = System::Drawing::Size(119, 18);
			this->label5->TabIndex = 27;
			this->label5->Text = L"Linea general";
			// 
			// panel2
			// 
...
#pragma endregion
	...
	private: System::Void cargarCombo() {
		...
		lista->leerFicheroGenerales();
		NodoGenerales * nodog = lista->getCab();
		while (nodog != NULL) {
			char * codigo = nodog->getInfo()->getCodigo();
			char * descripcion = nodog->getInfo()->getDescripcion();
