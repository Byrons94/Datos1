...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel1->Size = System::Drawing::Size(493, 331);
			...
			this->label2->Size = System::Drawing::Size(327, 25);
			this->label2->TabIndex = 11;
			this->label2->Text = L"Codigo del usuairo a modificar:";
			// 
			// button1
			// 
			...
			this->ClientSize = System::Drawing::Size(493, 331);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		ModificarUsuario2 ^ modif = gcnew  ModificarUsuario2(Utilitario::toChar(txtCodigo->Text));
		modif->Show();
